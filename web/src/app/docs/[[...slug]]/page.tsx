...
import { canonicalUrl, DEFAULT_DESCRIPTION, SITE_NAME, SOCIAL_IMAGE_URL } from "@/lib/seo";
...
export async function generateMetadata(props: DocPageProps): Promise<Metadata> {
  ...
  const title = doc ? doc.title : "Muzik Docs";
...
export default async function DocPage(props: DocPageProps) {
  ...
  const articleSchema = {
    ...
    url: canonicalUrl(path),
    about: ["self-hosted music", "YouTube Music downloader", "music library metadata", "Navidrome"],
    author: {
      "@type": "Person",
      name: "Gaya KACI",
